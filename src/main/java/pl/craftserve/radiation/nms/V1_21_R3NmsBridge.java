...
public class V1_21_R3NmsBridge implements RadiationNmsBridge {
    static final Logger logger = Logger.getLogger(V1_21_R3NmsBridge.class.getName());
    ...
    public V1_21_R3NmsBridge(String version) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to initialize 1.21.4 bridge", e);
        }
    }
    ...
    public void registerLugolsIodinePotion(NamespacedKey potionKey, LugolsIodinePotion.Config.Recipe config) {
        ...
        try {
            ...
            Object newPotion = this.potionRegistryClass.getConstructor(String.class, mobEffectArray.getClass())
                    .newInstance("name", mobEffectArray);
